        ...
        <el-row class="ml10">
          <el-col :span="8">
            <el-form :model="centerCPWDForm" :rules="CPWDrules" ref="centerCPWDForm">
              <el-form-item label="旧密码" prop="oldPassword" v-show="!changeAbout">
                <el-input type="password"  v-model="centerCPWDForm.oldPassword" clearable>
                </el-input>
              </el-form-item>
              <el-form-item label="密保问题：" prop="userAnswer" v-show="changeAbout">
                <span class="absolute ml100">{{userQuestion}}</span>
          ...
          <el-col :span="8" :offset="8" class="text-center">
            <el-button type="primary" @click="submitForm('centerCPWDForm')">提交</el-button>
          ...
          <el-col :span="8">
            <el-form :model="centerCQUESForm" :rules="CQUESrules" ref="centerCQUESForm">
              ...
              <el-form-item label="请选择新问题" prop="newQuestion">
                <el-input v-model="centerCQUESForm.newQuestion"  clearable></el-input>
              </el-form-item>
